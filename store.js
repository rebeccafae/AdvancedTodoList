...
ListStore = {
  ...
  loadItems: function() {
    var loadRequest = $.ajax({
      type: 'GET',
      url: "https://listalous.herokuapp.com/lists/rfjackson11/"
    })
  ...
  addItem: function(itemDescription) {
    var creationRequest = $.ajax({
      type: 'POST',
      url: "https://listalous.herokuapp.com/lists/rfjackson11/items",
  ...
  removeItem: function(itemId) {
    ...
    var updateRequest = $.ajax({
      type: 'DELETE',
      url: "https://listalous.herokuapp.com/lists/rfjackson11/items/" + itemId
    })
